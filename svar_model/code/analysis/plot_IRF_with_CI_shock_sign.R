...
if (VAR.P == 1 & Robustness == 0) {
  df_IRF_plot <- readRDS(file.path(DROPBOX_PATH, "./data/intermediate_result/df_IRF_plot.RDS"))
  df_IRF.sim <- read_rds(file.path(DROPBOX_PATH, paste0("./data/intermediate_result/df_IRF.sim_hrz40_", confidence_level*100, "CI.rds")))
} else if (Robustness == 1) {
  df_IRF_plot <- readRDS(file.path(DROPBOX_PATH, "./data/robustness/r1/df_IRF_plot.RDS"))
  df_IRF.sim <- read_rds(file.path(DROPBOX_PATH, paste0("./data/robustness/r1/df_IRF.sim_hrz40_", confidence_level*100, 
                                "CI.rds")))
} else if (Robustness == 2) {
  df_IRF_plot <- readRDS(file.path(DROPBOX_PATH, "./data/robustness/r2/df_IRF_plot.RDS"))
  df_IRF.sim <- read_rds(file.path(DROPBOX_PATH, paste0("./data/robustness/r2/df_IRF.sim_hrz40_", confidence_level*100, 
                                "CI.rds")))
} else if (Robustness == 3) {
  df_IRF_plot <- readRDS(file.path(DROPBOX_PATH, "./data/robustness/r3/df_IRF_plot.RDS"))
  df_IRF.sim <- read_rds(file.path(DROPBOX_PATH, paste0("./data/robustness/r3/df_IRF.sim_hrz40_", confidence_level*100, 
                                "CI.rds")))
} else if (Robustness == 4) {
  df_IRF_plot <- readRDS(file.path(DROPBOX_PATH, "./data/robustness/r4/df_IRF_plot.RDS"))
  df_IRF.sim <- read_rds(file.path(DROPBOX_PATH, paste0("./data/robustness/r4/df_IRF.sim_hrz40_", confidence_level*100, 
                                "CI.rds")))
}
...
title_list <- c(paste0("Reponse of ", title_list_response, " to ", negative_label, title_list_shock[1], " Shock"),
                ...
                paste0("Reponse of ", title_list_response, " to ", negative_label, title_list_shock[6], " Shock"),
                paste0("Reponse of ", title_list_response, " to ", negative_label, title_list_shock[7], " Shock")
                )
...
for (i in 1:num_var) {
  ...
  if (VAR.P == 1 & Robustness == 0) {
    if (shock_sign == (-1)) {
      ggsave_default(fig_temp, paste0("./result/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI_neg.pdf"),
                     width = 30, height = 40
      ) 
    } else if (shock_sign == 1) {
      ggsave_default(fig_temp, paste0("./result/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI.pdf"),
                     width = 30, height = 40
      ) 
    }
  } else if (Robustness == 1) {
    if (shock_sign == (-1)) {
      ggsave_default(fig_temp, paste0("./result/robustness/r1/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI_neg.pdf"),
                     width = 30, height = 40
      ) 
    } else if (shock_sign == 1) {
      ggsave_default(fig_temp, paste0("./result/robustness/r1/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI.pdf"),
                     width = 30, height = 40
      ) 
    }
  } else if (Robustness == 2) {
    if (shock_sign == (-1)) {
      ggsave_default(fig_temp, paste0("./result/robustness/r2/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI_neg.pdf"),
                     width = 30, height = 40
      ) 
    } else if (shock_sign == 1) {
      ggsave_default(fig_temp, paste0("./result/robustness/r2/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI.pdf"),
                     width = 30, height = 40
      ) 
    }
  } else if (Robustness == 3) {
    if (shock_sign == (-1)) {
      ggsave_default(fig_temp, paste0("./result/robustness/r3/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI_neg.pdf"),
                     width = 30, height = 40
      ) 
    } else if (shock_sign == 1) {
      ggsave_default(fig_temp, paste0("./result/robustness/r3/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI.pdf"),
                     width = 30, height = 40
      ) 
    }
  } else if (Robustness == 4) {
    if (shock_sign == (-1)) {
      ggsave_default(fig_temp, paste0("./result/robustness/r4/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI_neg.pdf"),
                     width = 30, height = 40
      ) 
    } else if (shock_sign == 1) {
      ggsave_default(fig_temp, paste0("./result/robustness/r4/figure/fig_IRF_shock", i, "_", confidence_level*100, "CI.pdf"),
                     width = 30, height = 40
      ) 
    }
  }
